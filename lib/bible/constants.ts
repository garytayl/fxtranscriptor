...
/** Canonical 66 books with chapter counts for progress tracking (e.g. HCSB import). Order matches OLD_TESTAMENT_BOOK_IDS + NEW_TESTAMENT_BOOK_IDS. */
export const BIBLE_BOOKS_WITH_CHAPTER_COUNTS: { id: string; name: string; chapters: number }[] = [
