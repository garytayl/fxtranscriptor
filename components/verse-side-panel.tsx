...
export function VerseSidePanel({
  ...
  return (
    <aside
      ref={panelRef}
      className="hidden lg:block fixed right-6 top-1/2 -translate-y-1/2 w-64 max-h-[80vh] overflow-y-auto z-20 scrollbar-thin scrollbar-thumb-accent/20 scrollbar-track-transparent"
    >
