...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase
      .from("sermons")
      .select("id, title, date, description, podbean_url, youtube_url, youtube_video_id, audio_url, transcript_source, transcript_generated_at, series, series_override, speaker, status, error_message, progress_json, created_at, updated_at")
